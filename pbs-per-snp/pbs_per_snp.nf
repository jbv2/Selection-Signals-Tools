...
def helpMessage() {
	log.info"""
  ==========================================
  The MXB PBS per SNP calculator
...
*/
if (params.version){
	println "MXB PBS per snp v${version}"
	exit 0
}

/*//////////////////////////////
  Define the Nextflow version under which this pipeline was developed or successfuly tested
  Updated by jballesteros at NOVEMBER 2021
*/
...
process _001_calculate_pbs_per_snp {
	...
	output:
	file "*.tsv" into results_001_calculate_pbs_per_snp
