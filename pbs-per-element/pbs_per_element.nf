...
Pre-processing:
  ...
  _pre2a_get_fst_for_ingroup_outgroup_element
	_pre2b_get_fst_for_target_ingroup_element
	_pre2c_get_fst_for_target_outgroup_element
	_pre3a_get_fst_for_ingroup_outgroup_snp
	_pre3b_get_fst_for_target_ingroup_snp
	_pre3c_get_fst_for_target_outgroup_snp
	_pre4_gather_chromosomes

Core-processing:
  _001_calculate_pbs_per_element
	_002_calculate_pbs_per_snp

Pos-processing
	_pos1_plot_pbs_per_element
...
log.info"""
==========================================
The MXB PBS per element calculator
- A pipeline for running PBS per gene or genomic feature (as lncRNA or enhancers)
v${version}
==========================================
"""
...
/* Read mkfile module files */
Channel
	.fromPath("${workflow.projectDir}/mkmodules/mk-get-fst-for-ingroup_outgroup-element/*")
	.toList()
	.set{ mkfiles_pre2a }

process _pre2a_get_fst_for_ingroup_outgroup_element {

	publishDir "${intermediates_dir}/_pre2a_get_fst_for_ingroup_outgroup_element/",mode:"symlink"

	input:
	file vcf from results_pre1_extract_autosomes_2a
	file populations from pops
	file mk_files from mkfiles_pre2a


	output:
	file "*.weighted" into results_pre2a_get_fst_per_element_weighted
...
/* Read mkfile module files */
Channel
	.fromPath("${workflow.projectDir}/mkmodules/mk-get-fst-for-target_ingroup-element/*")
	.toList()
	.set{ mkfiles_pre2b }

process _pre2b_get_fst_for_target_ingroup_element {

	publishDir "${intermediates_dir}/_pre2b_get_fst_for_target_ingroup_element/",mode:"symlink"

	input:
	file vcf from results_pre1_extract_autosomes_2b
	file populations from pops
	file mk_files from mkfiles_pre2b


	output:
	file "*.weighted" into results_pre2b_get_fst_per_element_weighted
...
/* Read mkfile module files */
Channel
	.fromPath("${workflow.projectDir}/mkmodules/mk-get-fst-for-target_outgroup-element/*")
	.toList()
	.set{ mkfiles_pre2c }

params.flag = false
process _pre2c_get_fst_for_target_outgroup_element {

	publishDir "${intermediates_dir}/_pre2c_get_fst_for_target_outgroup_element/",mode:"symlink"

	input:
	file vcf from results_pre1_extract_autosomes_2c
	file populations from pops
	file mk_files from mkfiles_pre2c


	output:
	file "*.weighted" into results_pre2c_get_fst_per_element_weighted
...
/* _pre4_gather_chromosomes */
/* Gather fst results  */
	results_pre2a_get_fst_per_element_weighted
  .mix(results_pre2b_get_fst_per_element_weighted
		,results_pre2c_get_fst_per_element_weighted)
  .collect()
  .set{ inputs_for_pre4 }

/* Read mkfile module files */
Channel
	.fromPath("${workflow.projectDir}/mkmodules/mk-gather-chromosomes/*")
	.toList()
	.set{ mkfiles_pre4 }

process _pre4_gather_chromosomes {

	publishDir "${intermediates_dir}/_pre4_gather_chromosomes/",mode:"symlink"

	input:
	file weighted from inputs_for_pre4
	file mk_files from mkfiles_pre4


	output:
	file "*.wfst" into results_pre4_gather_chromosomes
...
/* Read mkfile module files */
Channel
	.fromPath("${workflow.projectDir}/mkmodules/mk-calculate-pbs-per-element/*")
	.toList()
	.set{ mkfiles_001 }

process _001_calculate_pbs_per_element {

	publishDir "${results_dir}/_001_calculate_pbs_per_element/",mode:"copy"

	input:
	file weighted from results_pre4_gather_chromosomes
	file populations from pops
	file mk_files from mkfiles_001


	output:
	file "*.tsv" into results_001_calculate_pbs_per_element_tsv
	file "*.bed" into results_001_calculate_pbs_per_element_bed
...
/* Read mkfile module files */
Channel
	.fromPath("${workflow.projectDir}/mkmodules/mk-plot-pbs-per-element/*")
	.toList()
	.set{ mkfiles_pos1 }

process _pos1_plot_pbs_per_element {

	publishDir "${results_dir}/_pos1_plot_pbs_per_element/",mode:"copy"

	input:
	file pbs from results_001_calculate_pbs_per_element_tsv
	file populations from pops
	file mk_files from mkfiles_pos1


	output:
	file "*.png" into results_pos1_plot_pbs_per_element
